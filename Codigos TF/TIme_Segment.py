...
FirstPartPathOutput='/home/mreyes/Documents/Git/Tesis/EEG_spectro'#path where the segments will be saved

patients = ["04","07","08","09","10","11","13","14","15","16", "17"]
...
def saveSignalsOnDisk(signalsBlock,nSpectogram):
    ...
    for i,j in zip(range(0,signalsBlock.shape[0]),range(nSpectogram-signalsBlock.shape[0],nSpectogram)):
        ...
        id1.append(j)
        with h5py.File('/home/mreyes/Documents/Git/Tesis/EEG_spectro/EEG_segments_time_v3.h5', 'a') as archivo:
...
def createSpectrogram(data, S=0):
    ...
    while data.shape[1] - (t * movement + _SIZE_WINDOW_SPECTOGRAM) >= 0:
        ...
        signals = createSpec(data[:,start:stop])
...
def main():
    ...
    for indexPatient in range(0, len(patients)):
        ...
        df.to_csv('/home/mreyes/Documents/Git/Tesis/EEG_spectro/time_Segments_v2.csv', index=False)
